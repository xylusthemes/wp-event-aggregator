        ...
        <div class="wpea-setting-tab-container">
                        ...
                        <div class="fb_authorize">
                            <table class="form-table">
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            <?php esc_attr_e( 'Facebook Authorization','wp-event-aggregator' ); ?> : 
                                        </th>
                                        <td>
                                            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                                                ...
                                                ?>
                                                <input type="submit" class="button" name="wpea_facebook_authorize" value="<?php echo esc_attr( $button_value ); ?>" />
                                                <?php 
            ...
            <form method="post" id="wpea_setting_form">
                    <table class="form-table">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Facebook App ID','wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    ...
                                    <span class="wpea_small">
                                        ...
                                        printf( '%s <a href="https://developers.facebook.com/apps" target="_blank">%s</a>', 
                                            esc_attr__('You can veiw or create your Facebook Apps from', 'wp-event-aggregator'),
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Facebook App secret','wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Update existing events', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php 
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Advanced Synchronization', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php 
                                    if( wpea_is_pro() ){
            ...
            <form method="post" id="wpea_setting_form">
                <div class="wpea-setting-tab-child" id="eventbritesetting" >
                    <p><?php esc_attr_e( 'You need a Eventbrite Personal OAuth token to import your events from Eventbrite.','wp-event-aggregator' ); ?> </p>
                    <table class="form-table">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Eventbrite Private token','wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    ...
                                    <span class="wpea_small">
                                        <?php echo wp_kses_post( __( 'Insert your eventbrite.com Personal OAuth token you can get it from <a href="http://www.eventbrite.com/myaccount/apps/" target="_blank">here</a>.', 'wp-event-aggregator' ) ); ?>
                                    </span>
                                </td>
                            </tr>		
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Display ticket option after event', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Import Private Events', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php 
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Import Small Event Thumbnail', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php
                ...
                <div class="wpea-setting-tab-child" id="meetupsetting">
                        ...
                        <div class="fb_authorize">
                            <table class="form-table">
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            <?php esc_attr_e( 'Meetup Authorization','wp-event-aggregator' ); ?> :
                                        </th>
                                        <td>
                                            <?php
                                            if( !empty($meetup_authorized_user) && isset($meetup_authorized_user['name']) ) {
                                                ...
                                                ?>
                                                <a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=wpea_mauthorize_action' ), 'wpea_mauthorize_action', 'wpea_mauthorize_nonce' ) ); ?>" class="button button-primary">
                    ...
                    <table class="form-table">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Meetup OAuth Key','wp-event-aggregator' ); ?> :
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Meetup OAuth Secret','wp-event-aggregator' ); ?> :
                                </th>
                                <td>
                            ...
                            <tr>
                                <th scope="row" style="text-align: center" colspan="2">
                                    <?php esc_attr_e( ' - OR -', 'wp-event-aggregator' ); ?>
                                </th>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Meetup API key','wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                ...
                <div class="wpea-setting-tab-child" id="icalsettings">
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Import iCal Category', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php 
                                    if( wpea_is_pro() ){
                ...
                <div class="wpea-setting-tab-child" id="aggregatorsetting">
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Move past events in trash', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e('Direct link to Event Source', 'wp-event-aggregator'); ?> :
                                </th>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e('Event Slug', 'wp-event-aggregator'); ?> :
                                </th>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e('Skip Trashed Events', 'wp-event-aggregator'); ?> :
                                </th>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Disable WP Events', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php 
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_attr_e( 'Delete WP Event Aggregator data on Uninstall', 'wp-event-aggregator' ); ?> : 
                                </th>
                                <td>
                                    <?php 
